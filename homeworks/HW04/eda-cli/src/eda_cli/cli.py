...
def report(
    ...
    top_k_categories: int = typer.Option(5, help="Сколько значений выводить для категориальных столбцов."),
    ...
    with md_path.open("w", encoding="utf-8") as f:
        ...
        f.write(f"Top-K категориальных значений: **{top_k_categories}**\n\n")
